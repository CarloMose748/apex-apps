...
import { FiSearch, FiExternalLink, FiDownload, FiHelpCircle, FiRefreshCw } from 'react-icons/fi';
                ...
                onClick={async () => {
                  try {
                    ...
                    const payload = {
                      ...
                      issuedDate: new Date(item.issued_at).toLocaleDateString(),
    ...
    <div className="page">
      <div className="page__header">
        <div className="page__header-content">
          <h1 className="page__title">Your Certificates</h1>
          <p className="page__subtitle">Download compliance certificates for your waste oil collections with blockchain verification.</p>
        </div>
      </div>
